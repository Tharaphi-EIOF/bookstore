...
import { useCheckoutConfig } from '@/services/orders'
...
const CartPage = () => {
  ...
  const taxRatePercent = checkoutConfig?.taxRate ?? 10
  const taxAmount = Number((totalPrice * (taxRatePercent / 100)).toFixed(2))
